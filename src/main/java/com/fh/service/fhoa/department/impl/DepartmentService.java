...
public class DepartmentService implements DepartmentManager{
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<Department> listAllDepartment2(PageData pd)throws Exception{
		return (List<Department>)dao.findForList("DepartmentMapper.listAllDepartment2", pd);
	}
	/**列出表中所有要素 返回PageData
	 * @param page
	 * @throws Exception
	 */
	@SuppressWarnings("unchecked")
	public List<PageData> listAllDepartmentPD(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("DepartmentMapper.listAllDepartmentPD", pd);
	}
