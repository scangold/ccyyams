...
public class UserController extends BaseController {
	...
	public ModelAndView goAddU()throws Exception{
		...
		pd.put("ROLE_ID", "1");
		List<Role> roleList = roleService.listAllRolesByPId(pd);//列出所有系统用户角色
		List<Department> departmentList = departmentService.listAllDepartment2(pd);//列出所有部门
	...
	@RequestMapping(value="/changeUserByRoleId")
	@ResponseBody
	public Result changeUserByRoleId(String roleId) throws Exception{
		Result r;
		...
		r= userService.getUserByroleId(roleId);
		return r;
