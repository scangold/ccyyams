package com.fh.controller.system.archivedistribute;
...
@Controller
@RequestMapping(value="/archdistribute")
public class ArchdistributeController extends BaseController {
	...
	@RequestMapping(value="/goDistributeFormpage")
	public ModelAndView goDistributeFormpage() throws Exception{
		...
		mv.setViewName("system/apply/archdistribute");
		mv.addObject("pd", pd);
	...
	@RequestMapping(value="/getArchiverecordDesc")
	public ModelAndView  getArchiverecordDesc(){
		
			ModelAndView mv = this.getModelAndView();
		 mv.addObject("pd", applySerVice.getArchiverecordDesc(Integer.parseInt(this.getPageData().getString("distributeId"))));
		 mv.setViewName("system/archiverecordfile/archiverecordDesc");
		 return mv;
