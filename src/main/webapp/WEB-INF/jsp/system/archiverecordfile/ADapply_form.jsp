	...
	<form class="form-horizontal" role="form">
		<div class="main-container" id="main-container">
			<div style="margin-left: 10%; margin-right: 10%; margin-top: 10px">
				<h3 class="center" style="margin: auto; text-align: center;">申请表</h3>
				<div class="form-group">
					<div class="col-sm-10">
						<label for="lastname">申请原因：</label> 
						<input type="text" id="applyWhy" placeholder="请输入原因" class="text">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-10">
				...
				<div class="form-group" id="apply-left">
					...
					<textarea class="form-control" rows="5" cols="100%" id="descs"></textarea>
				</div>
...
<div>
<button type="button" class="btn" style="margin-left:490px">提交</button>
</div>
...
/* 
		$.ajax({
			...
			$("button").on('click', function() {
			  PipeApi.SaveApplyforms($("#applyWhy").val(),$("#returntime").val(),$("#descs").val(),'${ids }',function(mess){
				  console.log("---------------------------------------------------------------------------------------------------");
				  console.log(mess);
				  var r= mess.result;
				  var t= mess.desc;
