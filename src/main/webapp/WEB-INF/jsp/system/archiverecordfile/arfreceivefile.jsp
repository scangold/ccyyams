...
<body>
	...
	<form class="form-horizontal" role="form" action="upload" method="post"
		...
		<div class="form-group">
			<label  class="col-sm-2 control-label"><h3>接收档案</h3></label>		
	     <span>${pd}</span>
	   	</div>
		<div class="form-group">
			...
			<div class="col-sm-6">
				<select name="prjId" id="prjId"
					class="chosen-select form-control col-sm-2 " title="项目id">
				</select>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control" name="checkdetails"
					value="d:\档案" placeholder="请输入文件存放地址">
			</div>
		</div>
		<div class="form-group">
			<label for="rcName" class="col-sm-2 control-label">接收人名</label>
			<div class="col-sm-6">
				<input type="text" class="form-control" name="rcName" id="rcName"
