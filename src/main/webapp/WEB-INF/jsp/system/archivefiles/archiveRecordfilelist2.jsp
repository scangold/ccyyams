					...
					<div class="form-group">
						<div class="col-lg-6 col-sm-12 ">
							...
							<div class="col-lg-9 col-sm-8">
								<select id="proId" class="form-control" onchange="GetRecivebyPageDate()"></select>
							</div>
						</div>
					</div>
				</form>
			...
			<table id="table" data-search="true" data-toggle="table"
				...
				<thead>
					<tr>
						...
						<th data-field="fileattr3" data-sortable="true">项目</th>
						<th data-field="rc_name" data-sortable="true">移交者</th>
