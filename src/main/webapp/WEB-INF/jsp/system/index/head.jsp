			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					...
					<a class="navbar-brand">
						<small> <i><img src="static/login/logo1.png" /></i>${pd.SYSNAME} </small>
					</a>
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					...
					<!-- <li title="即时聊天" class="white"  onclick="creatw();"><i><img src="static/login/talk.png" /></i>&nbsp;&nbsp;即时聊天&nbsp;&nbsp;
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
						...
						<li title="站内信" class="white" onclick="fhsms();" id="fhsmstss">&nbsp;<i><img src="static/login/email.png" /></i>&nbsp;&nbsp;站内信&nbsp;&nbsp;
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
						...
						<li class="light-blue">
							<a data-toggle="dropdown"  class="dropdown-toggle" href="#">
								<img class="nav-user-photo" src="static/ace/avatars/my.png" alt="Jason's Photo" />
