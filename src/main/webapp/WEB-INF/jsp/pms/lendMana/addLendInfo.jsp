...
<table style="width:100%;background: #fff;">
						<tr>
						<td>
						<form action="pms/saveLendInfo.do" name="newLendForm" id="newLendForm" method="post" >
						...
						<table id="table_report" class="table">
										...
										<td  class="tdNew">到期时间:</td>
											<td><input class="span10 date-picker" name="endtime" id="endtime"  value="${pd.ENDTIME}" type="text" data-date-format="yyyy-mm-dd" style="width: 98%;" placeholder="2018-08-18" title="到期时间"/></td>
										...
										<tr>
                                         <td class="tdNew">借阅人:</td>
											...
											<select class="chosen-select form-control"  name="borrow_user_id" id="borrow_user_id" data-placeholder="请选择借阅人" style="vertical-align:top;" style="width:98%;" >
											...
											<td><input type="text" name="name" id="name"  value="${pd.NAME }"  placeholder="这里输入主题" title="主题" style="width:98%;"/></td>
										
											</tr>
										
										<tr>
											<td  class="tdNew">描述:</td>
											<td colspan='3'><input type="text" name="describle" id="describle"value="${pd.DESCRIBLE }" placeholder="这里输入借阅描述"  title="描述" style="width:98%;"/></td>
										</tr>
